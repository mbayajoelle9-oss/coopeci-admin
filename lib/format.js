...
export const roleLabel = (r) => ({
  ...
  cashier: 'Caissier', chief_cashier: 'Chef de caisse', internal_controller: 'Contrôleur interne',
  accountant: 'Comptable', chief_accountant: 'Chef comptable',
...
export const ROLE_OPTIONS = [
  ...
  { value: 'chief_cashier', label: 'Chef de caisse' },
  { value: 'internal_controller', label: 'Contrôleur interne' },
...
export const can = {
  ...
  creditEncode: (r) => ['credit_manager', 'credit_manager_deputy', 'director', 'chief_accountant', 'chief_accountant_deputy', 'accountant', 'super_admin'].includes(r),
  committee: (r) => ['committee_member', 'board_president', 'board_vice_president', 'board_member', 'director', 'credit_manager'].includes(r),
  cashier: (r) => ['cashier', 'chief_cashier', 'internal_controller', 'director', 'super_admin'].includes(r),
